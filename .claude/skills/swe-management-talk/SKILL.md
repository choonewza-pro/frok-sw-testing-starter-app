...
3. **Ask where it goes:**
   ...
   - JIRA back-post: only if the user explicitly says so. Show the exact ADF payload, wait for explicit _"post it"_ / _"go ahead"_ / _"yes,"_ then `POST /rest/api/3/issue/<KEY>/comment`.
